  ...
  <div class="container">
    ...
    <form action="{{ url('auth-login') }}" method="POST">
        ...
        <div class="text-center my-3">
            <p>Or</p>
            <button type="button" class="btn btn-facebook w-100"><i class="fa fa-facebook"></i> Đăng nhập bằng Facebook</button>
        </div>
    </form>
    ...
    <div class="auth-container" id="signup-form" style="display:none;">
      ...
      <form action="{{ url('register') }}" method="POST">
        ...
        <div class="form-group">
            ...
            <input type="password" class="form-control" id="signup-password-confirm" name="password_confirmation" placeholder="Confirm your password" required>
        </div>
        <button type="submit" class="btn btn-dark w-100">Đăng ký</button>
        <div class="text-center my-3">
            <p>Or</p>
            <button type="button" class="btn btn-facebook w-100"><i class="fa fa-facebook"></i> Đăng ký với Facebook</button>
        </div>
    </form>
